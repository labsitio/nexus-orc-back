...
export const confirmacoesAnonimizacao = platformSchema.table('confirmacoes_anonimizacao', {
  id: uuid('id').primaryKey(),
...
export const trilhaAuditoriaAcesso = platformSchema.table('trilha_auditoria_acesso', {
  id: uuid('id').primaryKey(),
  orcamentoId: uuid('orcamento_id').notNull(),
