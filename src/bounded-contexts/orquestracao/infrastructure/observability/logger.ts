 ...
 * (spec-001), `extracao/infrastructure/observability/logger.ts` (spec-002),
 * `validacao/infrastructure/observability/logger.ts` (spec-003) e
 * `busca-indexacao/infrastructure/observability/logger.ts` (spec-004) — réplica
