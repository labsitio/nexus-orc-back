 ...
 * de autenticação Cognito (T027, `criarAutenticacaoCognito`), injetado pela
 * composição raiz do handler Lambda; sem `preHandler`, a rota fica sem
 ...
 * composição por rota — ex. `[criarAutenticacaoCognito(...), criarExigenciaPapel([...])]`
