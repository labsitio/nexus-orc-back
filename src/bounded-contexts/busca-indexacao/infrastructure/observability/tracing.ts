 ...
 * (spec-001), `extracao/infrastructure/observability/tracing.ts` (spec-002) e
 * `validacao/infrastructure/observability/tracing.ts` (spec-003) — réplica
 ...
 */
export function iniciarObservabilidade(nomeServico = 'busca-indexacao'): NodeSDK {
