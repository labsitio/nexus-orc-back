...
/**
 * Ponteiro imutável para o dado bruto no S3 (bucket `nexo-orcamentos-raw`,
 * propriedade da Ingestão) — Extração é sempre read-only sobre esse arquivo.
 * Mesmo shape da spec 001, redefinido localmente (Princípio III).
 */
