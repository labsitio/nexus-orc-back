 ...
 * confirmado contra esta implementação em T041/#106, marcação PROVISÓRIO removida
 * do openapi.yaml). Consumido pelo controller (T039) quando este existir — aqui
 * define-se apenas o contrato, sem depender de nenhum caso de uso.
 *
