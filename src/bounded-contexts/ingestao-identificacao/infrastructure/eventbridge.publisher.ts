...
const SOURCE = 'nexo.ingestao-identificacao';

/**
 * Implementa `EventPublisher` (T014/#19) publicando no bus EventBridge
 * único `nexo-dominio-bus` (T013/#18). Todo caso de uso publica via esta
 * interface — nunca chama o SDK AWS diretamente (plan.md).
 */
