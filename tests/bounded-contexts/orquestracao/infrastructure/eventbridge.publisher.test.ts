...
import { EventBridgePublisher } from '../../../../src/bounded-contexts/orquestracao/infrastructure/eventbridge.publisher.js';
...
describe('EventBridgePublisher (orquestracao)', () => {
  it('publica no bus informado com source fixo `nexo.orquestracao` e detail-type do evento', async () => {
    ...
    expect(entrada.Source).toBe('nexo.orquestracao');
    expect(entrada.DetailType).toBe('OrcamentoAprovadoParaProcessamento');
