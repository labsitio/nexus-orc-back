...
import { criarAutenticacaoCognito } from '../../../../../src/bounded-contexts/ingestao-identificacao/interface/http/auth-cognito.middleware.js';
...
describe('criarAutenticacaoCognito', () => {
  beforeEach(() => {
