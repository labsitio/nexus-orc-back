...
import { criarAutenticacaoCognito } from '../../../../../src/bounded-contexts/extracao/interface/http/auth-cognito.middleware.js';
...
describe('criarAutenticacaoCognito (extracao)', () => {
  beforeEach(() => {
