...
import { EventBridgePublisher } from '../../../../src/bounded-contexts/busca-indexacao/infrastructure/eventbridge.publisher.js';
...
describe('EventBridgePublisher (busca-indexacao)', () => {
  it('publica no bus informado com source fixo `nexo.busca-indexacao` e detail-type do evento', async () => {
    ...
    expect(entrada.Source).toBe('nexo.busca-indexacao');
    expect(entrada.DetailType).toBe('OrcamentoIndexado');
