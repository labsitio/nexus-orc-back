...
import { criarLogger } from '../../../../../src/bounded-contexts/busca-indexacao/infrastructure/observability/logger.js';

describe('criarLogger (busca-indexacao)', () => {
  ...
  it('fixa bindings (orcamentoId, tenantId) no log para correlação ponta a ponta', () => {
    const logger = criarLogger({
      orcamentoId: '01973b1e-0000-7000-8000-000000000000',
      tenantId: '01973b1e-0000-7000-8000-000000000001',
    });
