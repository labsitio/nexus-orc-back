...
import { criarAutenticacaoCognito } from '../../../../../src/bounded-contexts/validacao/interface/http/auth-cognito.middleware.js';
...
describe('criarAutenticacaoCognito (validacao)', () => {
  beforeEach(() => {
