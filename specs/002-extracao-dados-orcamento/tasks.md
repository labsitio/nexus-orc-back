...
- [ ] T017 [P] [US1] Unit test do agregado `ExtracaoOrcamento.criar(referenciaClassificacao, referenciaBrutaS3)` + `registrarTentativaExtrator` com todos os campos obrigatórios completos → transita para `EXTRAIDO`.
